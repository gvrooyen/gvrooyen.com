...
<section>
    ...
    before <a href="https://octoco.ltd">Octoco</a> was founded, but remain Director and technical advisor.</p>
        ...
        can use the secret to anonymously claim a cryptocurrency bounty, thus revealing the identity of the <i>original
        infringer</i>, namely the movie reviewer. We successfully applied the same concept to images, e-books, and other
    ...
    <details>
        ...
        for a second time 🙈.</p>
        <p>I retain my ties to academia as Extra-Ordinary Professor, with a strong interest in innovation management and technology
            transfer. My research supervision includes the Internet of Things and Blockchain applications, and I lecture on these
